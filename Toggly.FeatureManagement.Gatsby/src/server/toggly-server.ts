 ...
 */
type ServerConfig = Required<Omit<TogglyPluginOptions, 'identity' | 'groups' | 'claims' | 'hooks' | 'localGates' | 'onError' | 'allowedKeyIds' | 'maxSignatureAgeSeconds' | 'enableLiveUpdates' | 'enableTelemetry' | 'enableUsageTracking' | 'enableMetrics' | 'metricsBaseUrl' | 'telemetryFlushIntervalMs'>> & {
  identity?: string;
  groups?: string[];
