...
namespace Toggly.FeatureManagement
{
    ...
    public static class VariantFeatureManagerExtensions
    {
        ...
        /// (null for reference types). Soft-null uses <c>default(T)</c> rather than
        /// <c>T?</c> so the helper stays valid on netstandard2.1 / netcoreapp3.1
        /// (CS8627). Existing MF APIs are unchanged.
        /// </returns>
