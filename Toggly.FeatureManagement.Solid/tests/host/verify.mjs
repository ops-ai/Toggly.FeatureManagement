...
try{
 ...
 assert.deepEqual(errors,[]);console.log('PASS packed SolidStart SSR, signed hydration, concurrent guarded actions, navigation, entity gates, live invalidation, invalid signature, offline retention, disposal and browser secret/import scan');
