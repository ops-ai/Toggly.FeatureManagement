 ...
 *
 * Uses a pure-JS SHA-256 so Edge / browser bundlers never see a static
 * `node:crypto` import (Next.js Edge + Turbopack fail on that module).
 */
...
/** Sync SHA-256 digest (32 bytes) — Edge-safe, no Node builtins. */
