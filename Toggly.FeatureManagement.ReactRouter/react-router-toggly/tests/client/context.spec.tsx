...
import type { ServerFeatureContext, TogglyHook } from '../../src/core';
...
describe('TogglyProvider', () => {
  ...
  describe('entity context', () => {
    ...
    beforeEach(async () => {
      const { clearRegisteredContexts } = await import('../../src/core');
  ...
  describe('WebSocket live updates', () => {
    ...
    it('should connect to WebSocket on mount', async () => {
      ...
      expect(MockWebSocket.instances[0].url).toBe('wss://definitions.toggly.io/test-key/ws?sdk=react-router&sdkVersion=1.1.0');
    });
    ...
    it('should build ws:// URL from http:// baseUrl', async () => {
      ...
      expect(MockWebSocket.instances[0].url).toBe('ws://localhost:3000/test-key/ws?sdk=react-router&sdkVersion=1.1.0');
    });
