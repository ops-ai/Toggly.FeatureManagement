...
namespace Toggly.FeatureManagement
{
    ...
    {
        /// <summary>
        /// Creates an attribute that signals a feature was used.
        /// </summary>
        ...
        {
            IFeatureUsageStatsProvider statsProvider = context.HttpContext.RequestServices.GetRequiredService<IFeatureUsageStatsProvider>();

            foreach (var feature in Features)
                await statsProvider.RecordUsageAsync(feature);
