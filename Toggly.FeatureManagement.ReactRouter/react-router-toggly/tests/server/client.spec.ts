...
import { TogglyServerClient, createServerClient } from '../../src/server/client';
import {
  TogglyConfig,
  TogglyHook,
  HookMetadata,
...
import * as signedResponse from '../../src/server/signed-response';
import { featureDefs, mockDefsFetchResponse } from './defs-helpers';

jest.mock('../../src/server/signed-response', () => {
  const actual = jest.requireActual('../../src/server/signed-response');
  return {
    ...actual,
