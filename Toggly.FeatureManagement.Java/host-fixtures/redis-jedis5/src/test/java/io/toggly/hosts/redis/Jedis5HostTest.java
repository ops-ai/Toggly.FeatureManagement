...
import io.toggly.cache.redis.RedisCachingSnapshotProvider;
...
class Jedis5HostTest {

    @Test
    void retainedAdapterStoresReadsAndClearsTheExistingSnapshotKey() {
        String host = System.getProperty("redis.host");
        int port = Integer.parseInt(System.getProperty("redis.port"));
        String prefix = "toggly:host:jedis5:";
