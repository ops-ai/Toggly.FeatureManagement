 ...
 */
export function buildFlagGateIndex(gates) {
    const index = new Map();
 ...
 */
export function isLocalPrerequisiteMet(flagKey, gates, gateIndex) {
 ...
 */
export function applyLocalGate(remote, flagKey, gates, gateIndex) {
    if (!remote) {
        return false;
    }
 ...
 */
export function applyLocalGatesToMap(remoteFlags, gates, gateIndex) {
