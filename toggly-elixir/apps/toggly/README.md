...
Requires Elixir **1.20+** and Erlang/OTP **29+**. Verified on Elixir 1.20.4 / OTP 29. Use `toggly` **0.4.0+** for ambient client identity on catalog-local variants; `toggly_phoenix` **0.2.0+** for `Plug.get_variant/2`.
